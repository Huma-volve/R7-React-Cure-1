...
import prfileAvatar from "../../../../public/Avatar.svg"
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                ...
                >
                    <img src={prfileAvatar} alt="Profile" loading="lazy" />
                </Button>
            </DropdownMenuTrigger>
            ...
            >
                <DropdownMenuGroup>
                    <div className="flex items-center mb-4 justify-between gap-2 px-2">
                        <Link to="/profile" className="flex items-center gap-2">
                            ...
                            <div className="profile-info">
                                <p
                                    className="font-semibold sm:text-[20px] text-[18px]"
                    ...
                    <Link to="/privacy">
                        <DropdownMenuItem className="mb-3 cursor-pointer text-[16px] hover:bg-gray-300! transition-colors">
                            <img
                                src="/icons/Lock Keyhole Minimalistic.svg"
                                alt="Privacy"
                                loading="lazy"
                            />
                            Privacy Policy
